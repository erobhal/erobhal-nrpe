...
# DO NOT EDIT
#
command[check_root_partition]=/usr/lib/nagios/plugins/check_disk -w 20% -c 10% -p /
command[check_load]=/usr/lib/nagios/plugins/check_load -w 10,8,8 -c 12,10,9
...
command[check_load]=/usr/lib64/nagios/plugins/check_load -w 10,8,8 -c 12,10,9
...
command[check_load]=/usr/local/nagios/libexec/check_load -w 10,8,8 -c 12,10,9
